...
public:
	...
	*/
	TiXmlText (const char * initValue ,bool bcdata = false) : TiXmlNode (TiXmlNode::TEXT)
	{
		SetValue( initValue );
		cdata = bcdata;
	}
	...
	#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlText( const std::string& initValue,bool bcdata = false ) : TiXmlNode (TiXmlNode::TEXT)
	{
		SetValue( initValue );
		cdata = bcdata;
	}
